# calculator.rb
# "$" make global variable that can be used by any method.
# line 4 hash of operations.
$operations = {
  99 => 'Exit',
  1 => '+ Addition',
  2 => '- Substraction',
...
def get_numbers
  ...
  return [first_number, second_number] # "return" is optional for method returns the last thing it executes.
end

loop do 
  display_menu()
  option = gets().chomp()
  is_valid = valid_option?(option.to_i) # $operations.key?(option.to_i)
  unless is_valid
    puts "Invalid Option!"
    next
  end
